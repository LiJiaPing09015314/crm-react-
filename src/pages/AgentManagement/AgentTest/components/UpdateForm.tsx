...
import { Form, Button, Input, Modal, Radio, TreeSelect, Steps ,InputNumber,Row,Col} from 'antd';
import {editRule,menuRule} from "../service";
    ...
    return (
      <>
        ...
        <FormItem
          ...
          name="rebate"
          label="返佣"
          rules={[{ message: '',type: 'number', min: 0, max: 1}]}
        >
